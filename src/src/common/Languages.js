...
export default new LocalizedStrings({
  en: {
    ...
    AddCredit: "AddCredit",
    CouponExchange:'Insufficient points',
    CouponExchangeLimit:'Exchange has reached the upper limit',
    CouponExchangeSuccess:'Successfully redeemed',
    copySuccess:'copy success',
    couponTips:'Click the exchange code area to copy the exchange code of the coupon',
    // Scene's Titles
    Home: "Home",
    Intro: "Intro",
    Product: "Product",
    ...
    Error: "Error",
    OrderStatusChangeErr:'Order modification failed',
    OrderStatusChangeSuccess:'Order modification completed',
  ...
  cn: {
    CouponExchange:'积分不足',
    CouponExchangeLimit:'兑换已达上限',
    CouponExchangeSuccess:'兑换成功',
    AddCredit: "获取积分",
    Exit: "退出",
    ...
    pleaseLogin:'请先登录',
    copySuccess:'复制成功',
    couponTips:'点击Code区域可以复制优惠券的兑换码',
    ////场景的标题
    Home: "家",
    Intro: "介绍",
    Product: "产品",
    ...
    Error: "错误",
    OrderStatusChangeErr:'订单修改失败',
    OrderStatusChangeSuccess:'订单修改完成',
  ...
  tc: {
    ...
    Error: "錯誤",
    OrderStatusChangeErr:'訂單修改失敗',
    OrderStatusChangeSuccess:'訂單修改完成',
    ...
    AddCredit: "獲取積分",
    CouponExchange:'積分不足',
    CouponExchangeLimit:'兌換已達上限',
    CouponExchangeSuccess:'兌換成功',
    copySuccess:"複製成功",
