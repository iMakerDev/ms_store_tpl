...
const Images = {
  ...
  icons: {
    ...
    iconMember: require("@images/icons/member.png"),
    iconNotMember: require("@images/icons/notMember.png")
  },
  Banner: {
  ...
  portrait: [
    require('@images/portrait/portrait1.png'),
    require('@images/portrait/portrait2.png'),
    require('@images/portrait/portrait3.png'),
    require('@images/portrait/portrait4.png'),
    require('@images/portrait/portrait5.png'),
    require('@images/portrait/portrait6.png'),
    require('@images/portrait/portrait7.png'),
    require('@images/portrait/portrait8.png'),
    require ('@images/portrait/portrait9.png'),
    require('@images/portrait/portrait10.png'),
    require ('@images/portrait/portrait11.png'),
    require('@images/portrait/portrait12.png'),
  ]
};
